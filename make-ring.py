...
ZYPPER_CLIENT_GNOME_DEPENDENCIES = [
    'gtk3-devel', 'clutter-gtk-devel', 'gettext-tools', 'libnotify-devel',
...
ZYPPER_CLIENT_QT_DEPENDENCIES = [
    ...
    'libqt5-qtdeclarative-devel', 'libQt5QuickControls2-devel'
]
...
DNF_DEPENDENCIES = [
    ...
    'sqlite-devel', 'openssl-static', 'pandoc', 'nasm', 'qrencode-devel'
]

DNF_CLIENT_GNOME_DEPENDENCIES = [
    'gtk3-devel', 'clutter-devel', 'clutter-gtk-devel', 'libnotify-devel','libappindicator-gtk3-devel',
    'webkitgtk4-devel', 'NetworkManager-libnm-devel', 'libcanberra-devel'
]
...
APT_DEPENDENCIES = [
    ...
    'pandoc', 'nasm', 'libqrencode-dev'
]

APT_CLIENT_GNOME_DEPENDENCIES = [
    'libwebkit2gtk-4.0-dev', 'libnm-dev', 'libappindicator3-dev', 'libcanberra-gtk3-dev'
]
