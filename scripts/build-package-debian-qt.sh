...
cp "$cached_tarball" qt-jami_${qt_version}.orig.tar.xz
tar xvf qt-jami_${qt_version}.orig.tar.xz
mv qt-everywhere-src-${qt_version} qt-jami-${qt_version}
cd qt-jami-${qt_version}
