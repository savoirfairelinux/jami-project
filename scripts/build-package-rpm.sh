...
cp patches/0001-qtbug-102017-sporadic-binding-crash.patch /root/rpmbuild/SOURCES/
cp patches/0002-qtbug-101201-fatal-errror-getcurrenkeyboard.patch /root/rpmbuild/SOURCES/
