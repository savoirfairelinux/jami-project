#!/usr/bin/env bash
#
# This script is used in the packagign containers to build packages on
...
dch --create --package ring --newversion ${RELEASE_VERSION}~dfsg1-1 "Automatic nightly release"
