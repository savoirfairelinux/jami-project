...
# TODO: replace 'internal' with 'nightly' when merging
sh -c "echo 'deb [signed-by=/usr/share/keyrings/jami-archive-keyring.gpg] https://dl.jami.net/internal/debian_10_qt/ jami main' > /etc/apt/sources.list.d/qt-jami.list"
apt-get update
